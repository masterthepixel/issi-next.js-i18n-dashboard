...
export const seed = async (payload: Payload): Promise<void> => {
  ...
  // Create sample categories (temporarily disabled to fix admin panel initialization)
  /*
  ...
  */
  payload.logger.info('Categories seeding skipped for admin panel initialization');

  // Get admin user for blog posts (temporarily disabled)
  /*
  ...
  if (adminUserId) {
    // Sample data creation temporarily disabled for admin panel initialization
    payload.logger.info('Sample blog posts creation skipped');
  }
  */

  payload.logger.info('Blog post seeding skipped for admin panel initialization');
  const samplePosts = [
    {
      title: {
