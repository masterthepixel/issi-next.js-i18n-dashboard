    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-left">
          <h2 id="awards-heading" className="text-balance text-foreground sm:text-5xl font-serif font-[400]">
            <FormattedMessage id="about.awards.title" defaultMessage="Our Awards" />
          </h2>
          <p className="mt-6 max-w-2xl text-lg/8 text-muted-foreground">
            <FormattedMessage
        ...
        <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 gap-6 sm:max-w-xl sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3" role="list">
          {awards.map((award) => (
            <Card key={award.id} className="group hover:shadow-lg transition-all duration-300 border-0" role="listitem">
