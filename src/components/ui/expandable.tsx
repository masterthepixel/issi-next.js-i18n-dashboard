    ...
    (
        ...
        return (
            ...
            >
                <div
                    className={cn(
                        "grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-[1.5rem] h-full",
...
export {
    Expandable, ExpandableCard, ExpandableCardContent,
    ExpandableCardFooter, ExpandableCardHeader, ExpandableContent,
    ExpandableContext,
    ExpandableTrigger, useExpandable
}
