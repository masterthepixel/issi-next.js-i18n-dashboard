  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        {isHovered && <EvervaultCardContent mouseX={mouseX} mouseY={mouseY} randomString={randomString} />}
      </div>
    </div>
  );
}
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        ...
        style={style}
      />
      <motion.div className="absolute inset-0 mix-blend-overlay opacity-40" style={style}>
