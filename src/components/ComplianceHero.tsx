        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              ...
              <h1 id="compliance-hero-heading" className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-slate-900 dark:text-slate-100 sm:text-5xl">
          ...
          <div className="flex items-start justify-end lg:order-first">
            <Image
              ...
              width={2432}
              height={1442}
              className="w-[48rem] max-w-none rounded-xl bg-slate-50 shadow-xl ring-1 ring-slate-400/10 sm:w-[57rem]"
              loading="lazy"
            />
          </div>
        </div>
