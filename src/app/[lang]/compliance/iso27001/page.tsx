      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl  " text-muted-foreground1141="true">
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="dark: sm:text-4xl mb-4">
              {intl.formatMessage({ id: "iso27001.features.title" })}
            </h2>
            <p className="text-lg  " text-muted-foreground2548="true">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="glass-card p-8 rounded-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.features.risk.title" })}</h3>
              <p className="" text-muted-foreground3617="true">
            ...
            <div className="glass-card p-8 rounded-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.features.access.title" })}</h3>
              <p className="" text-muted-foreground4506="true">
            ...
            <div className="glass-card p-8 rounded-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.features.monitoring.title" })}</h3>
              <p className="" text-muted-foreground5500="true">
            ...
            <div className="glass-card p-8 rounded-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.features.incident.title" })}</h3>
              <p className="" text-muted-foreground6425="true">
            ...
            <div className="glass-card p-8 rounded-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.features.continuity.title" })}</h3>
              <p className="" text-muted-foreground7361="true">
            ...
            <div className="glass-card p-8 rounded-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.features.training.title" })}</h3>
              <p className="" text-muted-foreground8418="true">
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="dark: sm:text-4xl mb-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="dark:">{intl.formatMessage({ id: "iso27001.certification.initial.title" })}</h3>
                    <p className="" text-muted-foreground9796="true">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="dark:">{intl.formatMessage({ id: "iso27001.certification.surveillance.title" })}</h3>
                    <p className="" text-muted-foreground10684="true">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="dark:">{intl.formatMessage({ id: "iso27001.certification.renewal.title" })}</h3>
                    <p className="" text-muted-foreground11555="true">
            ...
            <div className="glass-effect-strong p-8 rounded-2xl">
              <div className="text-center">
                ...
                <h3 className="dark: mb-4">{intl.formatMessage({ id: "iso27001.certificate.title" })}</h3>
                <div className="space-y-3 text-left">
                  <div className="flex justify-between">
                    <span className="" text-muted-foreground12779="true">{intl.formatMessage({ id: "iso27001.certificate.standard" })}</span>
                    <span className="font-medium text-slate-900 dark:text-white">{intl.formatMessage({ id: "iso27001.certificate.standard.value" })}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="" text-muted-foreground13163="true">{intl.formatMessage({ id: "iso27001.certificate.number" })}</span>
                    <span className="font-medium text-slate-900 dark:text-white">{intl.formatMessage({ id: "iso27001.certificate.number.value" })}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="" text-muted-foreground13543="true">{intl.formatMessage({ id: "iso27001.certificate.valid" })}</span>
                    <span className="font-medium text-slate-900 dark:text-white">{intl.formatMessage({ id: "iso27001.certificate.valid.value" })}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="" text-muted-foreground13921="true">{intl.formatMessage({ id: "iso27001.certificate.scope" })}</span>
                    <span className="font-medium text-slate-900 dark:text-white">{intl.formatMessage({ id: "iso27001.certificate.scope.value" })}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="" text-muted-foreground14299="true">{intl.formatMessage({ id: "iso27001.certificate.body" })}</span>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg  " text-muted-foreground15059="true">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.process.plan.title" })}</h3>
              <p className="" text-muted-foreground15736="true">
            ...
            <div className="text-center">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.process.do.title" })}</h3>
              <p className="" text-muted-foreground16319="true">
            ...
            <div className="text-center">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.process.check.title" })}</h3>
              <p className="" text-muted-foreground16905="true">
            ...
            <div className="text-center">
              ...
              <h3 className="dark: mb-3">{intl.formatMessage({ id: "iso27001.process.act.title" })}</h3>
              <p className="" text-muted-foreground17492="true">
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg  " text-muted-foreground18148>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="glass-card p-8 rounded-xl">
              ...
              <h3 className="dark: mb-4">{intl.formatMessage({ id: "iso27001.benefits.government.title" })}</h3>
              <ul className="space-y-2  " text-muted-foreground19114>
            ...
            <div className="glass-card p-8 rounded-xl">
              ...
              <h3 className="dark: mb-4">{intl.formatMessage({ id: "iso27001.benefits.energy.title" })}</h3>
              <ul className="space-y-2  " text-muted-foreground21059>
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
            ...
            <div className="glass-card p-8 rounded-xl">
              ...
              <h3 className="dark: mb-4">{intl.formatMessage({ id: "iso27001.benefits.commercial.title" })}</h3>
              <ul className="space-y-2  " text-muted-foreground23236>
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg  " text-muted-foreground24974>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg  " text-muted-foreground27793>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/support"
                className="inline-flex items-center justify-center px-6 py-3 border border-slate-300 dark:border-slate-600 text-base font-medium rounded-md  " text-muted-foreground28144
              >
