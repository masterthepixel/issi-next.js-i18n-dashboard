...
export const metadata = {
  title: "License - ISSI - International Software Systems International",
  ...
  return (
    <div>
      <div className="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
        <Card>
          <CardHeader>{intl.formatMessage({ id: "page.license.title" })}</CardHeader>
          <CardBody>
            <p className="text-base text-slate-700 dark:text-slate-300">
              {intl.formatMessage({ id: "page.license.description" })}
            </p>
          </CardBody>
        </Card>
      </div>
