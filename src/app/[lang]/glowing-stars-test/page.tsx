      ...
      >
        <div className="relative z-10 container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-lg  " text-muted-foreground1011>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-md rounded-xl p-6 border border-slate-200/50 dark:border-slate-700/50">
              <h3 className="dark: mb-4">
                Background Features
              </h3>
              <ul className="space-y-2  " text-muted-foreground1662>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <h4 className="dark: mb-2">Low Density</h4>
            ...
            <div className="text-center">
              <h4 className="dark: mb-2">Medium Density</h4>
              <div className="relative h-32 bg-white/50 dark:bg-slate-900/50 rounded-lg overflow-hidden">
            ...
            <div className="text-center">
              <h4 className="dark: mb-2">High Density</h4>
              <div className="relative h-32 bg-white/50 dark:bg-slate-900/50 rounded-lg overflow-hidden">
