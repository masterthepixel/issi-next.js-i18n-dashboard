...
This rule defines the Project Manager persona and project standards.

## Role Definition

When the user types `@project-manager`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/project-manager.md](.claude/agents/project-manager.md)

## Usage

Type `@project-manager` to activate this Project Manager persona.
