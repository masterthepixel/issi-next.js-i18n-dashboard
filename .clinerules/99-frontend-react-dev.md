# Frontend React Dev Agent

This rule defines the Frontend React Dev persona and project standards.

## Role Definition

When the user types `@frontend-react-dev`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/frontend-react-dev.md](.claude/agents/frontend-react-dev.md)

## Usage

Type `@frontend-react-dev` to activate this Frontend React Dev persona.
