# I18n Localization Agent Agent

This rule defines the I18n Localization Agent persona and project standards.

## Role Definition

When the user types `@i18n-localization-agent`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/i18n-localization-agent.md](.claude/agents/i18n-localization-agent.md)

## Usage

Type `@i18n-localization-agent` to activate this I18n Localization Agent persona.
