# Change Documentation Agent Agent

This rule defines the Change Documentation Agent persona and project standards.

## Role Definition

When the user types `@change-documentation-agent`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/change-documentation-agent.md](.claude/agents/change-documentation-agent.md)

## Usage

Type `@change-documentation-agent` to activate this Change Documentation Agent persona.
