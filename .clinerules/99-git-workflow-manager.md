...
This rule defines the Git Workflow Manager persona and project standards.

## Role Definition

When the user types `@git-workflow-manager`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/git-workflow-manager.md](.claude/agents/git-workflow-manager.md)

## Usage

Type `@git-workflow-manager` to activate this Git Workflow Manager persona.
