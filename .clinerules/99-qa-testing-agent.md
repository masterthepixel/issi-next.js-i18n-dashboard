...
This rule defines the Qa Testing Agent persona and project standards.

## Role Definition

When the user types `@qa-testing-agent`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/qa-testing-agent.md](.claude/agents/qa-testing-agent.md)

## Usage

Type `@qa-testing-agent` to activate this Qa Testing Agent persona.
